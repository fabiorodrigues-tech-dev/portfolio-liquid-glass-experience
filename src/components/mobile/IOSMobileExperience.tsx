    ...
    <div className="relative w-full h-[100dvh] overflow-hidden text-zinc-900 dark:text-white font-sans selection:bg-blue-500 selection:text-white">
      ...
      >
        ...
        {activeTab === 'projetos' && (
          <div className="space-y-3.5 animate-in fade-in duration-200">
            <div className="px-1">
              <span className="ios-header-contour-label block text-[11px] font-mono tracking-wider uppercase font-semibold text-zinc-700 dark:text-white/60 transition-colors">
                {currentDateFormatted || 'DOMINGO, 6 DE SETEMBRO'}
              </span>
              <h2 className="ios-header-contour-title text-2xl sm:text-3xl font-black font-display tracking-tight text-zinc-950 dark:text-white transition-colors">

  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-stretch">
        ...
        <div className="flex-1 bg-white/90 border border-black/20 shadow-[0_8px_30px_rgba(0,0,0,0.08)] rounded-2xl p-6 flex flex-col justify-between dark:bg-black/20 dark:border-white/10 dark:shadow-none">
          <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-zinc-400 shadow-[0_2px_8px_rgba(0,0,0,0.08)] focus:border-blue-600 focus:ring-1 focus:ring-blue-600/30 text-zinc-900 placeholder:text-zinc-500 rounded-xl px-4 py-3 text-xs transition-all outline-none dark:bg-black/20 dark:border-white/10 dark:text-white dark:placeholder:text-zinc-500"
                    />
                  </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full bg-white border border-zinc-400 shadow-[0_2px_8px_rgba(0,0,0,0.08)] focus:border-blue-600 focus:ring-1 focus:ring-blue-600/30 text-zinc-900 placeholder:text-zinc-500 rounded-xl px-4 py-3 text-xs transition-all outline-none resize-none dark:bg-black/20 dark:border-white/10 dark:text-white dark:placeholder:text-zinc-500"
                  />
                </div>
        ...
        <div className="hidden lg:block w-px bg-black/10 dark:bg-white/10 self-stretch my-2" />
        ...
        <div className="w-full lg:w-[380px] xl:w-[420px] shrink-0 flex flex-col">
          ...
          <div className="bg-white/95 border border-black/20 shadow-[0_4px_16px_rgba(0,0,0,0.06)] hover:border-black/40 hover:shadow-md rounded-2xl p-4 mb-3.5 last:mb-0 transition-all flex items-center justify-between dark:bg-black/20 dark:border-white/10 dark:shadow-none">
            <div className="flex items-center space-x-3">

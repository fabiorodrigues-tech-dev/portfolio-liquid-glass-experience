...
export const Dock: React.FC<DockProps> = ({
  ...
  return (
    <div
      ...
      className={`border border-white/25 dark:border-white/20 shadow-[0_16px_40px_rgba(0,0,0,0.45)] rounded-[22px] px-3 py-1.5 flex items-center gap-2 select-none fixed bottom-4 left-1/2 -translate-x-1/2 z-40 transition-all
